...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h3 mb-0">Fechamento Consultor</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="GET" action="{{ route('relatorio-fechamento-consultor.index') }}" class="row g-3 mb-4">
                <div class="col-md-3">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @can('view', $relatorio)
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('relatorio-fechamento-consultor.show', $relatorio) }}">
                                                            <i class="fas fa-eye"></i> Visualizar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('relatorio-fechamento-consultor.pdf', $relatorio) }}" target="_blank">
                                                ...
                                                @can('update', $relatorio)
                                                    ...
                                                    @if($relatorio->status === 'aprovado')
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <form method="POST" action="{{ route('relatorio-fechamento-consultor.enviar-email', $relatorio) }}" style="display: contents;">
                                                                @csrf
                                                                <button type="submit"
                                                    ...
                                                    @if($relatorio->status === 'rascunho' || $relatorio->status === 'rejeitado')
                                                        <li class="mt-2">
                                                            <form method="POST" action="{{ route('relatorio-fechamento-consultor.destroy', $relatorio) }}" style="display: contents;"
...
<script>
const baseRoute = '/relatorio-fechamento-consultor';
