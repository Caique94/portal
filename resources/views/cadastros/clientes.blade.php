                ...
                <div class="modal-body">
                    <form id="formCliente" action="#" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating mb-3 col-md-3">
                                <input type="text" name="txtClienteNumero" id="txtClienteNumero" class="form-control" placeholder="N&uacute;mero" />
                                <label for="txtClienteNumero">N&uacute;mero</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-floating mb-3 col-md-12">
                                <input type="text" name="txtClienteComplemento" id="txtClienteComplemento" class="form-control" placeholder="Complemento" />
                                <label for="txtClienteComplemento">Complemento</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-floating mb-3 col-md-6">
