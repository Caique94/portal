...
class ClienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'txtClienteNumero'          => 'nullable|string|max:50',
            'txtClienteComplemento'     => 'nullable|string|max:255',
        ...
        $mappedData = [
            ...
            'numero'            => $validatedData['txtClienteNumero'] ?? null,
            'complemento'       => $validatedData['txtClienteComplemento'] ?? null,
